...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="detail10.css" />
  </head>
  <body>
    <?php
    session_start(); 
    ...
    <div class="main-container">
      ...
      <div class="flex-row-be">
        ...
        <span class="so-alpha-camera"
          >SONY G LENS 24-70mm f1.8</f1></span>
        <span class="rm-price">RM 3,000.00</span>
    ...
    <script>
      ...
      <div class="rectangle-1c">
        ...
        <div class="flex-row-cd">
          <a href="Homepage.php" class="home-1d">Home</a>
          <a href="photo1.html" class="photography-service">Photography Service</a>
       </div>
        <div class="flex-row-ed-1e">
          <a href="product.php" class="shop-1f">Product</a>
        </div>
        <a href="contact.php" class="contact-20">Contact</a>
